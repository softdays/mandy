 ...
 * @author rpatriarche
 */
define([ 'angular', 'angular-route', 'angular-cookies', 'mandy-common',
    'mandy-datagrid-service' ], function(angular) {
  'use strict';

  var module = angular.module('mdDatagridRoute', [ 'ngRoute', 'ngCookies',
  ...
  module
      .config([
          ...
          function($routeProvider) {
            ...
            var route = {
              ...
              resolve : {
                ...
                imputations : [
                    ...
                    '$cookieStore',
                    'ImputationService',
                    function($rootScope, $route, $cookieStore,
                        imputationService) {
                      // $cookieStore permet de gérer le refresh sauvage
                      var userId = $cookieStore.get('user').resourceId;
                      var year = $route.current.params.year;
                      var month = $route.current.params.month;
                      return imputationService.findImputations(userId, year,
                          month);
                    } ]
              }
            };
            ...
            $routeProvider.when('/datagrid/year/:year/month/:month/day/:day',
                route);
