 ...
 */
define([
           'angular', 'angular-route', 'blockui', 'mandy-common', 'mandy-datagrid-service'
       ], function(angular){
    'use strict';

    var module = angular.module('mdDatagridControllerViewDay', [
        'ngRoute', 'mdCommon', 'mdDatagridService'
    ]);

    module.controller('DatagridDayViewController',
                      [
                          '$rootScope',
                          '$scope',
                          '$location',
                          ...
                          function($rootScope,
                               ...
                               */
                              $scope.$on('md.datagrid.imputation.save',
                                         function(event, imputationId, activityId, newQuota, newComment){
                              ...
                              $scope.updateImputation = function(pmItem, newQuotaValue, newComment){
                                  ...
                                  if (isSyncRequired(pmItem, newQuotaValue, newComment)) {
                                      ...
                                      var asyncToken = $scope.synchronizeBackend(imputationId,
                                                                                 pmItem.activity.id,
                                                                                 utils.getDate(strDate),
                                                                                 newQuotaValue,
                                                                                 comment);
