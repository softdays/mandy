...
define(
    ...
    function(angular, moment) {
        ...
        var UtilsService = function() {
            ...
            /**
             * Returns the next quota value from an existing quota value. This function use the
             * given granularity value to determine the correct value. If the next value is not
             * compliant with the current granularity, the closest compliant value is used instead.
             */
                ...
                if (reverse) {
                    if (q === 0) {
                        ...
                        if (!isNewQuotaInPossibleValues(newQuota, values)) {
                            // if new value not in values takes the closest
                            // lower value
            ...
            function($rootScope, $location, $log, $timeout) {
                ...
                this.errorHandler = function(httpResponse, context) {
                    ...
                    if (status === 0) {
                        ...
                        // force redirection to the home page to display login
                        // form
                        window.location = "./";
                    } else {
        ...
        module.controller('ErrorController', [ '$rootScope', '$scope', '$sce', 'missingRoute',
