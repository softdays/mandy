...
define(['angular', 'mandy-common', 'mandy-datagrid-service'], function(angular){
    ...
    var module = angular.module('mdDatagridController', [
                      ...
                      [
                          ...
                          function($rootScope,
                              ...
                              $scope.saveModalChanges = function(imputationId, activityId, newQuota, newComment){
                                  $scope.$broadcast('md.datagrid.imputation.save',
                                                    imputationId,
                                                    activityId,
                                                    newQuota,
                                                    newComment);
                               ...
                               * @public
                               */
                              $scope.synchronizeBackend =
                                  function(imputationId, activityId, date, newQuota, newComment){
                                      var resource = null;
                                      var asyncToken = {
                                          type: null,
                                          promise: null
                                      ...
                                      if (imputationId) {
                                          ...
                                          asyncToken.promise =
                                              imputationService.createImputation(+$rootScope.user.resourceId,
                                                                                 activityId,
                                                                                 date,
                                                                                 newQuota,
                                                                                 newComment);
