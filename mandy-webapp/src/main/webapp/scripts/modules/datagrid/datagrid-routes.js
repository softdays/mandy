 ...
 */
define([
           'angular', 'angular-route', 'angular-cookies', 'mandy-datagrid-service'
       ], function(angular){
    'use strict';
    ...
    module.config([
            ...
            var route = {
                ...
                resolve: {
                    ...
                    datagrid: [
                        '$route', 'CalendarService', function($route, calendarService){
                    ...
                    activities: [
                        'ActivityService', function(activityService){
