...
define(['angular', 'mandy-common'], function(angular){
    ...
    module.directive('mandyDatagridHeader', [
        "$q", "Utils", function($q, utils){
            return {
                restrict: 'A',
                scope: false,
                replace: false,
                ...
                link: function(scope, element){
                    ...
                    $q.all([
                               scope.datagrid.$promise, scope.imputationsMap.$promise
                           ]).then(function(){
                        ...
                        angular.forEach(weeks, function(week){
                            angular.forEach(week.days, function(day){
                                ...
                                var completenessGlyphiconIcon = utils.getCompletenessGlyphiconClass(scope.imputationsMap,
                                                                                                    day.date);
    ...
    module.directive('mandyDatagridBody', [
        "$q", "Utils", function($q, utils){
                ...
                link: function(scope, element){
                    $q.all([
                        ...
                        angular.forEach(scope.activities, function(activity, index){
                            ...
                            angular.forEach(scope.datagrid.weeks, function(week){
                                angular.forEach(week.days, function(day){
    ...
    module.directive('mandyDatagridBodyViewDay', [
        "$q", function($q){
